...
define(function (require) {
    ...
    synthEngine.nodes.eqLow = createFilter({ type: 'lowshelf', frequency: 120, q: 2, gain: 100 });
    ...
    synthEngine.nodes.eqHigh = createFilter({ type: 'highshelf', frequency: 6400, q: 1, gain: 15 });
    ...
    synthEngine.play = function () {
        ...
        this.nodes.output.gain.setTargetAtTime(1, currentTime, 0.025);
        return this;
    };
